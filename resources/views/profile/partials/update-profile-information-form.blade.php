<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="mt-1 block w-full form-control" :value="old('username', $user->username)" required autofocus autocomplete="name" />
        ...
        <div class="flex items-center gap-4 mt-4">
            ...
            @if (session('status') === 'profile-updated')
                ...
                >{{ __('Updated Profile Information.') }}</p>
            @endif
        </div>
    </form>
</section>
